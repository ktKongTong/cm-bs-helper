...
fun TaskStatus.isFinite():Boolean {
    return when(this) {
        is TaskStatus.Initial -> false
        is TaskStatus.Queued -> false
        is TaskStatus.Running -> false
        is TaskStatus.PostProcessing -> false
        is TaskStatus.Completed,is TaskStatus.Cancelled,is TaskStatus.Paused -> true
        is TaskStatus.Failed -> true
        is TaskStatus.Unknown -> false
