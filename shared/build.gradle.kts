...
buildConfig {
    ...
    buildConfigField("FEEDBACK_URL", "https://bs-helper.api.ktlab.io/feedback")
    buildConfigField("BS_IMG_PROXY", "https://cf-img.ktlab.io/beatsaver")
    buildConfigField("List<kotlin.text.Regex>","BS_IMG_PATTERNS", arrayOf("Regex(\"https://(.+\\\\.)?cdn\\\\.beatsaver\\\\.com\")"))
