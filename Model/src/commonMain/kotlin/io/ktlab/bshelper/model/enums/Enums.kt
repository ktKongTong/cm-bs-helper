...
class ECharacteristicSerializable : KSerializer<ECharacteristic> {
    ...
    override fun deserialize(decoder: Decoder): ECharacteristic =
        ECharacteristic.from(decoder.decodeString())
    override fun serialize(encoder: Encoder, value: ECharacteristic) = encoder.encodeString(value.toString())
}